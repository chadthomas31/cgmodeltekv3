...
export const metadata: Metadata = {
  ...
  description: "Aerospace manufacturing excellence: wind tunnel models, flight test components, and aerospace tooling.",
};
      ...
      <div className="px-4">
        ...
        <section id="wind-tunnel" className="scroll-mt-24 rounded-xl border bg-card p-5">
          ...
          <p className="mt-2 text-muted-foreground">
            Scaled models and fixtures built to stringent aerodynamic tolerances. Surface finish and profile accuracy
            optimized for repeatable test data.
          </p>
          <div className="mt-4">
            <Link href="/rfq" className="focus-ring rounded-md bg-primary px-4 py-2 text-primary-foreground text-sm">Request a Quote</Link>
          </div>
        </section>
        ...
        <section id="flight-test" className="mt-10 scroll-mt-24 rounded-xl border bg-card p-5">
          ...
          <p className="mt-2 text-muted-foreground">
            Instrumentation housings, aerodynamic fairings, and structural adapters produced with process control and
            documentation suitable for demanding test campaigns.
          </p>
          <div className="mt-4">
            <Link href="/rfq" className="focus-ring rounded-md bg-primary px-4 py-2 text-primary-foreground text-sm">Request a Quote</Link>
          </div>
        ...
        <section id="tooling" className="mt-10 scroll-mt-24 rounded-xl border bg-card p-5">
          ...
          <p className="mt-2 text-muted-foreground">
            Precision fixtures, drill guides, and assembly tooling designed for reliability and alignment integrity.
          </p>
          <div className="mt-4">
            <Link href="/rfq" className="focus-ring rounded-md bg-primary px-4 py-2 text-primary-foreground text-sm">Request a Quote</Link>
          </div>

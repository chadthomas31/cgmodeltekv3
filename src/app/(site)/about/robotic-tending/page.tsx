    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="mt-12 rounded-lg border bg-primary/5 p-6">
        <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Talk with our automation team about your goals.</p>
          </div>
      ...
      <section className="mt-12">
        ...
        <div className="mt-4">
          <Accordion
            items={[
              { id: "cells", title: "Do you build custom cells?", content: "We integrate off-the-shelf robotics into proven cell designs." },
              { id: "inspection", title: "What about inspection?", content: "In-process probing and offline CMM ensure quality." },
            ]}
          />
        </div>
      </section>

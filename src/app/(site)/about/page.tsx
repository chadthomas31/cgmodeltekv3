...
export const metadata: Metadata = {
  ...
  description:
    "Learn about cgmodeltek's mission, robotics integration, customer reviews, and FAQs.",
};
  ...
  return (
    <div className="container mx-auto px-0 pb-12">
      <Hero
        ...
        image={{
          src: "/images/about_us_v2.png",
          alt: "Team and advanced manufacturing environment",
        }}
      ...
      <div className="px-4">
        ...
        <section className="mt-12">
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">
            Meet the team guiding our engineering, operations, and customer success.
          </p>
          ...
          <LeadershipGrid
            ...
            people={[
              ...
              },
              {
                ...
                role: "Title",
                img: "",
                bio: "Short 2–3 sentence bio goes here.",
              },
              {
                name: "Name Here",
                role: "Title",
          ...
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Request a quote and we’ll review your CAD same-day.
              </p>
            </div>
            <Link
              href="/contact"
              ...
              items={[
                {
                  ...
                  content: "±0.0005 in typical; tighter possible upon request.",
                },
                {
                  id: "lead",
                  title: "Lead times?",
                  content: "Rapid prototypes in days; production in weeks depending on volume.",
                },
                {
                  id: "materials",
                  title: "Materials?",
                  content:
                    "Aluminum, steels, titanium, copper alloys, engineering plastics, and more.",
                },
              ]}
            />
          </div>
